...
local mappings = {
    ...
    c = {
        ...
        t = { '<cmd>CMakeSelectBuildTarget<CR>', 'SelectTarget' },
        T = { '<cmd>CMakeSelectBuildType<CR>', 'SelectBuildType' },
        k = { '<cmd>CMakeSelectKit<CR>', 'SelectKit' },
        b = { '<cmd>CMakeBuild<CR>', 'Build' },
        r = { '<cmd>CMakeRun<CR>', 'Run' },
        d = { '<cmd>CMakeDebug<CR>', 'Debug' },
        c = { '<cmd>CMakeClean<CR>', 'Clean' },
        C = { '<cmd>CMakeCleanReBuild<CR>', 'CleanAndReBuild' },
        o = { '<cmd>CMakeOpen<CR>', "OpenMenu" },
        q = { '<cmd>CMakeClose<CR>', 'CloseMenu' },
    },
